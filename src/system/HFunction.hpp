...
private:
	const FuncData *_vfunc;
	function_glue *_glue;
	hvalue _thisObject;

    HFunction(HvmEnv *env, hclass functionClass, const FuncData *vfunc, function_glue *glue, std::string ownerPackage = "", hvalue thisObject = nullptr);
...
public:
	...
	const FuncData *vfunc() const { return _vfunc; }
